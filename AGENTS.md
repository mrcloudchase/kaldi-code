...
This file provides guidance to AI coding agents when working with code in this repository. Always make sure this is up to date as you change the codebase. Never mention co authored by coding agents in your commits or PRs.
